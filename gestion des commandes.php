        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"  style="color:rgb(131, 41, 148)">Gestion des commandes <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block"></span>
              </h3>
              <div class="d-flex">
...
<!-- END HEADER DESKTOP-->
 ...
 <form  action="triedate.php">
											...
											<h3  style="color:black " >Trier les commandes selon la date </h3><button> <img src="images/d.png"></button>
		                        </form>

								
                                                   <form  action="trieD.php">
       	                                       
											<h3  style="color:black " >Trier les commandes selon l'adresse</h3><button> <img src="images/a.png"></button>
		                        </form>
								
								<br>
								<form  action="triecc.php">
       	                                   <h3  style="color:black" > Trier les commandes selon montant des commandes </h3><button><img src="images/d.png"></button>
		                        </form>
                      ...
                      <table class="table table-striped" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                        <thead>
                          <tr>
                             <th style="color:rgb(131, 41, 148)">Détail commande</th>
                            <th style="color:rgb(131, 41, 148)">Date commande</th>
                            <th style="color:rgb(131, 41, 148)">Prix commande</th>
                             <th style="color:rgb(131, 41, 148)">Lieu livraison</th>
                             <th style="color:rgb(131, 41, 148)">Valider</th>
                         <th style="color:rgb(131, 41, 148)">Annuler</th>
                         <th style="color:rgb(131, 41, 148)">PDF</th>
                      ...
                      <td>
                        ...
                        <form method="POST" action="validercommande.php">
                              <button class="btn btn-outline-secondary btn-rounded btn-icon" name="valider" onsubmit="test()"; ><img src="images/1.png"></button>
                              <input type="hidden" value="<?PHP echo $row['idCommande']; ?>" name="idCommande">
                        </form>
                        </td>
                        <td>
                        <form method="POST" action="supprimercommande.php">
                              <button class="btn btn-outline-secondary btn-rounded btn-icon" name="supprimer" ><img src="images/2.png"></button>
                              <input type="hidden" value="<?PHP echo $row['idCommande']; ?>" name="idCommande">
                        </form> </td>
