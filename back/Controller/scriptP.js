function minDtate() {
    ...
    today = yyyy + "-" + mm + "-" + dd;
    document.getElementById("DateF").setAttribute("min", today - 10);
}
...
function checkAndFilterFiles() {
    ...
    if (!allowedExtensions(IMG)) {
        document.getElementById("IMGP").innerHTML = "Please you can upload file having extensions .jpeg/.jpg/.png/.gif only";
        verif = 0;
        return false;
    } else verif = 1;
}
