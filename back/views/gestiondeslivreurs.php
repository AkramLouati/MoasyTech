        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"> Gestion des livreurs <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block"></span>
              </h3>
              <div class="d-flex">
                        ...
                        <tbody>
                          ...
                          <td>
                            <form method="POST" action="Modifierlivreur.php">
                              ...
                              <input type="hidden" value=<?PHP echo $livreur['idL']; ?> name="idL">
                            </form>
                          </td>
                          <td>
                            <a href="Supprimerlivreur.php?id=<?php echo $livreur['idL']; ?>">Supprimer</a>
                          </td>
                          </tr>
                          <tr>
                            <td class="py-1">
