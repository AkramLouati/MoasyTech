      ...
      <div class="main-panel">
        <div class="content-wrapper pb-0">
          <div class="page-header flex-wrap">
            ...
            <h3 class="mb-0" style="color:rgb(131, 41, 148)">Gestion des promotions<span class="pl-0 h6 pl-sm-2 text-muted d-inline-block"></span>
            </h3>
            <div class="d-flex">
              ...
              <button type="button" class="btn btn-sm ml-3 btn-success"><a href="ajouterPromotion.php">Ajouter Une Promotion</a></button>
            </div>
          </div>
                        ...
                        <thead>
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                <a href="supprimerPromotion.php?Id=<?php echo $Promotion['Id']; ?>"><img src="images/2.png"></a>
                              </td>
                            </tr>
                          <?php
                          }
