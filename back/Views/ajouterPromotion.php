                                            ...
                                            <form action="" method="POST" onsubmit="return Validation()">
                                                <table class="table table-striped" align="center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="file" name="IMG" id="IMG"  accept="image/*" onchange="return checkAndFilterFiles()">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div><input hidden readonly type="text" name="Nom" id="Nom" maxlength="20">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="date" onclick="minDtate()" name="DateF" id="DateF">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td onchange="Equation()"><input type="number" step="any" name="PrixA" id="PrixA">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td onchange="Equation()"><input type="number" step="any" name="Remise" id="Remise">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="number" step="any" name="PrixN" value="0.000" id="PrixN" readonly></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
