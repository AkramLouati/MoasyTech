            ...
            <div class="main-panel">
                <div class="content-wrapper pb-0">
                    <div class="page-header flex-wrap">
                        ...
                        <h3 class="mb-0" style="color:rgb(131, 41, 148)">Gestion des reclamations<span class="pl-0 h6 pl-sm-2 text-muted d-inline-block"></span>
                        </h3>
                        <div class="d-flex">
                            ...
                            <button type="button" class="btn btn-sm ml-3 btn-success"><a href="gestion des Reclamations.php">Retour Gestion Des Reclamations</a></button>
                        </div>
                    </div>
                    <?php
                    if (isset($_POST['Id'])) {
                                            ...
                                            <div class="table-responsive">
                                                <form action="" method="POST" onsubmit="return Validation()">
                                                    <table class="table table-striped" align="center">
                                                        <tr>
                                                            <th style="color:rgb(131, 41, 148)">CIN</th>
                                                            <td><input readonly type="text" name="Id" id="Id" value="<?php echo $Reclamation['Id']; ?>" maxlength="8">
                                                                <span id="CINT" class="text-danger font-weight-bold"> </span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th style="color:rgb(131, 41, 148)">Nom</th>
                                                            <td><input type="text" name="Nom" id="Nom" value="<?php echo $Reclamation['Nom']; ?>" maxlength="10">
                                                                <span id="NomT" class="text-danger font-weight-bold"> </span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th style="color:rgb(131, 41, 148)">Prenom</th>
                                                            <td><input type="text" name="Prenom" id="Prenom" value="<?php echo $Reclamation['Prenom']; ?>" maxlength="10">
                                                                <span id="PrenomT" class="text-danger font-weight-bold"> </span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th style="color:rgb(131, 41, 148)">Texte Reclamation</th>
                                                            <td>
                                                                <textarea name="TexteR" id="TexteR" cols="30" rows="5"><?php echo $Reclamation['TexteR']; ?></textarea>
                                                                <span id="TexteRT" class="text-danger font-weight-bold"> </span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th style="color:rgb(131, 41, 148)">Email</th>
                                                            <td>
                                                                <input type="Email" name="Email" id="Email" value="<?php echo $Reclamation['Email']; ?>">
                                                                <span id="EmailT" class="text-danger font-weight-bold"> </span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th style="color:rgb(131, 41, 148)">Date Reclamation</th>
                                                            <td>
                                                                <input readonly type="date" name="DateR" id="DateR" value="<?php echo date('Y-m-d'); ?>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
