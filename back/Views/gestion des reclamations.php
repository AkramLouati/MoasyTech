        ...
        <div class="content-wrapper pb-0">
          <div class="page-header flex-wrap">
            ...
            <div class="d-flex">
              ...
              <button type="button" class="btn btn-sm ml-3 btn-success"><a href="ajouterReclamation.php">Ajouter Une Reclamation</a></button>
            </div>
          </div>
                      ...
                      <table class="table table-striped" align="center">
                        <thead>
                          <tr>
                            ...
                            <th style="color:rgb(131, 41, 148)">Modifier</th>
                            <th style="color:rgb(131, 41, 148)">Valider</th>
                            <th style="color:rgb(131, 41, 148)">Supprimer</th>
                          </tr>
                          ...
                          ?>
                            <tr>
                              ...
                              <td><textarea rows="5" readonly><?php echo $Reclamation['TexteR']; ?></textarea></td>
                              ...
                              <td>
                                <form method="POST">
                                  <a href="validerReclamation.php?Id=<?php echo $Reclamation['Id']; ?>"><img src="images/1.png"></a>
                                </form>
                              </td>
                              <td>
                                <form method="POST">
                                  <a href="supprimerReclamation.php?Id=<?php echo $Reclamation['Id']; ?>"><img src="images/2.png"></a>
                                </form>
                              </td>
                            </tr>
                          <?php
