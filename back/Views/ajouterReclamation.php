            ...
            <div class="main-panel">
                <div class="content-wrapper pb-0">
                    <div class="page-header flex-wrap">
                        ...
                        <h3 class="mb-0" style="color:rgb(131, 41, 148)">Ajouter une reclamation<span class="pl-0 h6 pl-sm-2 text-muted d-inline-block"></span>
                        </h3>
                        <div class="d-flex">
                                            ...
                                            <form action="" method="POST" onsubmit="return Validation()">
                                                <table class="table table-striped" align="center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="Nom" id="Nom" maxlength="10">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="Prenom" id="Prenom" maxlength="10">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><textarea name="TexteR" id="TexteR" cols="30" rows="5"></textarea>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input readonly value="<?php echo date('Y-m-d'); ?>" type="date" name="DateR" id="DateR"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
