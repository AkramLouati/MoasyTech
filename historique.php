        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"  style="color:rgb(131, 41, 148)">Historique des commandes <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block"></span>
              </h3>
...
<table class="table table-bordered table-striped mb-none"  id="myTable2" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
							<thead>
								<tr>
													...
													<th style="color:rgb(131, 41, 148)">ID commande</th>
													<th style="color:rgb(131, 41, 148)">Date</th>
													<th style="color:rgb(131, 41, 148)">Montant</th>
													<th style="color:rgb(131, 41, 148)">Etat</th>
													<th style="color:rgb(131, 41, 148)">Adresse</th>
