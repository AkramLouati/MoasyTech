...
require_once 'C:\xampp\htdocs\user\model\mdp.php';
require_once 'C:\xampp\htdocs\user\model\user.php';
//Require PHP Mailer
require_once 'C:\xampp\htdocs\user\PHPMailer-master\src\PHPMailer.php';
require_once 'C:\xampp\htdocs\user\PHPMailer-master\src\Exception.php';
require_once 'C:\xampp\htdocs\user\PHPMailer-master\src\SMTP.php';
class ResetPasswords{
    ...
    public function sendEmail(){
        ...
        if(!filter_var($email, FILTER_VALIDATE_EMAIL)){
            ...
            redirect("C:/xampp/htdocs/user/views/front/forgetmdp.php");
        }
        ...
        $this->mail->setFrom('med.achi94@gmail.com');
