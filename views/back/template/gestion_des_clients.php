        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"> Gestion des clients <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block"></span>
              </h3>
              ...
              <div class="d-flex">
                ...
                <button type="button" class="btn btn-sm bg-white btn-icon-text border ml-3">
                  ...
                  <button type="button" class="btn btn-sm ml-3 btn-success"><a href="ajouter.php"> Add User</a> </button>
              </div>
            </div>
         ...
         ?>
                ...
                <tr>
                     ...
                     <td><?php echo $user['rolee'] ?></td>
   
                     <td>
                        <!--Bouton delete  -->
                   <a class="btn btn-sm ml-3 btn-success" href="supprimer.php?ee=<?php echo $user['id'] ?>">supprimer</a>  
				 <br>
				 <br>
				<a class="btn btn-sm ml-3 btn-success" href="modifier.php?id=<?php echo $user['id'] ?>">modifier</a>	
