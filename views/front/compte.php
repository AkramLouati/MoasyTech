...
if(isset($_POST['creer'])){
    ...
    if(empty($username_err) && empty($adresse_err) && empty($nom_err) && empty($prenom_err) && empty($email_err) && empty($mdp_err) && empty($rolee_err)){
            ...
            $utilisateur = new utilisateur($prenom,$nom,$email,$mdp,$adresse,"client",$username);
    $empC= new user();
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="login_part_text_iner">
                            ...
                            <p>Créez un compte gratuitement et accédez simplement à un ensemble de services personnalisés </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        ...
                        <label>email</label>
                            ...
                            <span class="invalid-feedback"><?php echo $adresse_err;?></span>
                                    ...
                                    <button type="submit" value="submit" name= "creer" class="btn_3">
                                        log in
                                    </button>
                                </div>
                            </form>
