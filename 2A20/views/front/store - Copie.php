    ...
    <section class="product_list section_padding">
        <div class="container">
            <div class="row">
                ...
                $listeProduits=$Produit1C->trieprix();
                ?>

<td>
   <button >
                                            <a href="trieprix.php"></a> </button> 
...
<table class="table table-bordered table-striped mb-none"  id="myTable2" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                            <thead>
                                <tr>
                                        ...
                                        <th onclick="sortTable(4)">colie</th>
...
?>
    ...
    <td><?PHP echo $row['nb_calories']; ?></td>
    <td><?PHP echo $row['libelle']; ?></td>
    <td ><?PHP echo "<img src='productlist/".$row['img']."' >"; ?></td>
