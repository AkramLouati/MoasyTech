    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="images/ach" alt="John Doe" />
                                        </div>
                                        <div class="content">
            ...
            <!-- END HEADER DESKTOP-->
                ...
                $listeProduits=$Produit1C->trieid();
                ?>

<td>
   <button >
                                            <a href="trieid.php"></a> </button> 
...
<table class="table table-bordered table-striped mb-none"  id="myTable2" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                            <thead>
                                <tr>
                                        <th onclick="sortTable(0)">identifiant du produit </th>
                                        <th onclick="sortTable(1)">nom produit</th>
                                        <th>description</th>
                                        <th onclick="sortTable(3)">prix</th>
                                        <th onclick="sortTable(4)">quantite</th>
                                        <th onclick="sortTable(4)">categorie</th>
...
?>
    ...
    <a href="modifierp.php?editid=<?php echo $row['id'];?>">
    ...
    <a href="supprimerp.php?delid=<?php echo $row['id'];?>">
