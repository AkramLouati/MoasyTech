 ...
 <div class="col-md-9 cart-items" >
  ...
  $chemin="images/produit/".$id;                             ?>
             ...
             <div class="price-details">
                <br><br><br>
                 <h3  style="color:rgb(255, 133, 71)">Les  Détails</h3> 
                 <br>
                 <span style="color:rgb(255, 133, 71)">Total</span>
                 <span class="total1"> <?php echo $somme." DT"; ?></span>
                 
                 <span style="color:rgb(255, 133, 71)">Delivery Charges</span>
                 <span class="total1"><?php echo ($somme*1.18)." DT"; ?></span>
                 <span style="color:rgb(255, 133, 71)">Date</span><br>
                 <span class="total1"><?php $date = new DateTime(); echo $date->format('Y-m-d H:i:s');?></span>
                 <span style="color:rgb(255, 133, 71)">Secteur</span>
                 <span>
                 <select name="secteur">
                  <option value="Ariana">
                    Ariana
