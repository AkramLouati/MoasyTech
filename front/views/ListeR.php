...
<head>
    ...
    <title>Reclamation | Liste Reclamation</title>
    <link rel="icon" href="">
    <!-- Bootstrap CSS -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb_iner">
                        <h2 class="glow">Liste Des Reclamations</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="cart_inner">
                <div class="table-responsive">
                    <a class="btn_1 checkout_btn_1" href="reclamation.php">Ajouter une reclamation</a>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">CIN</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="ModifierR.php">
                                            <input class="btn_3" type="submit" name="Modifier" value="Modifier">
                                            <input type="hidden" value=<?PHP echo $Reclamation['Id']; ?> name="Id">
                                        </form>
                                    </td>
                                    <td><?php echo $Reclamation['Validee']; ?></td>
                                    <td>
                                        <form method="post">
                                            <a href="supprimerReclamation.php?Id=<?php echo $Reclamation['Id']; ?>">
                                                <center><img height="35" src="IMG/2.png"></center>
                                            </a>
                                        </form>
                                    </td>
                                </tr>
                    ...
                    <div class="checkout_btn_inner float-right">
                        <a class="btn_1" target="_blank" rel="noopener noreferrer" href="chartR.php">Statistique</a>
                        <a class="btn_1 checkout_btn_1" target="_blank" rel="noopener noreferrer" href="pdfR.php">PDF</a>
                    </div>
                </div>
            </div>
    </section>
